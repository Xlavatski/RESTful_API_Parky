...
namespace ParkyAPI.Controllers
{
    ...
    public class TrailsController : ControllerBase
    {
        ...
        public IActionResult GetTrails()
        {
            ...
            var vmDto = _mapper.Map<List<TrailDto>>(objList);
        ...
        /// </summary>
        /// <param name="trailId"> The Id of Tarail </param>
        /// <returns></returns>
        ...
        public IActionResult GetTrail(int trailId)
        {
            ...
            var vmDto = _mapper.Map<TrailDto>(obj);
        ...
        {
            var objList = _trailRepository.GetTrailsInNationalParks(nationalParkId);
            if (objList == null)
            {
                return NotFound();
            }
        ...
        public IActionResult UpdateTrail(int trailId, [FromBody] TrailUpdateDto trailDto)
        {
            ...
            var trailObj = _mapper.Map<Trail>(trailDto);
            if (!_trailRepository.UpdataTrail(trailObj))
            {
                ModelState.AddModelError("", $"Something went wrong when updateing the record {trailObj.Name}");
                return StatusCode(500, ModelState);
            }
